...
<?php
	...
	$query	=mysqli_query($gathuk, "SELECT * FROM tb_skripsi ORDER BY id_skripsi DESC");
?>
<div class="row">
	<!-- begin col-12 -->
    <div class="col-md-12">
				...
				<table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php $tamDsn	=mysqli_query($gathuk, "SELECT * FROM tb_dosen WHERE id_dosen='$data[id_dosen]'");
									$tdsn	=mysqli_fetch_array($tamDsn);?>
								<a type="button" style="cursor:pointer;" data-toggle="modal" data-target="#Detdsn<?php echo $tdsn['id_dosen'];?>" title="detail dosen"><?=$tdsn['nidn']?></a>
							</td>

							<td><?php $tamDsn2	=mysqli_query($gathuk, "SELECT * FROM tb_dosen WHERE id_dosen='$data[id_dosen2]'");
									$tdsn2	=mysqli_fetch_array($tamDsn2);?>
								<a type="button" style="cursor:pointer;" data-toggle="modal" data-target="#Detdsn<?php echo $tdsn2['id_dosen'];?>" title="detail dosen"><?=$tdsn2['nidn']?></a>
							</td>
							...
							<td class="text-center">
								...
								if ($data['approve_prodi'] ==""){
									echo '
									<a type="button" class="btn btn-warning btn-icon btn-sm" data-toggle="modal" data-target="#App'.$data['id_skripsi'].'" title="Approval"><i class="ion-android-checkbox fa-lg"></i></a>
									<a type="button" class="btn btn-default btn-icon btn-sm" href="javascript:;" title="wait approve prodi"><i class="ion-navigate fa-lg"></i></a>
									';
								}
								else {
									if ($data['approve_prodi'] =="N"){
										echo '
										<a type="button" class="btn btn-default btn-icon btn-sm" href="javascript:;" title="Approve prodi done"><i class="ion-android-checkbox fa-lg"></i></a>
										<a type="button" class="btn btn-default btn-icon btn-sm" href="javascript:;" title="Prodi not approved"><i class="ion-navigate fa-lg"></i></a>
										';
									}
									else{
										echo '
										<a type="button" class="btn btn-default btn-icon btn-sm" href="javascript:;" title="Approve prodi done"><i class="ion-android-checkbox fa-lg"></i></a>
										<a type="button" class="btn btn-success btn-icon btn-sm" data-toggle="modal" data-target="#Send'.$data['id_skripsi'].'" title="Pilih Dosen Pembimbing"><i class="ion-navigate fa-lg"></i></a>
										';
									}
								}
								?>
									...
									<div class="col-md-12">
										<div class="profile-section">
											<div class="col-md-12">
												...
												<div class="modal-body">
													<label class="col-md-3"><b><u>Status Dosen Pembimbing 1</u></b></label>
													<span class="col-md-9"></span>	
												</div>
												<div class="modal-body">
													<label class="col-md-3">NIDN</label>
													<span class="col-md-9">: <?php $tamDsn	=mysqli_query($gathuk, "SELECT * FROM tb_dosen WHERE id_dosen='$data[id_dosen]'");
														$tdsn	=mysqli_fetch_array($tamDsn);
														echo $tdsn['nidn'];?>
													</span>	
												</div>
												...
												<div class="modal-body">
													<label class="col-md-3">Catatan Dosen</label>
													<span class="col-md-9">: <?=$data['catatan_dosen']?></span>	
												</div>

												<div class="modal-body">
													<label class="col-md-3"><b><u>Status Dosen Pembimbing 2</u></b></label>
													<span class="col-md-9"></span>	
												</div>
												<div class="modal-body">
													<label class="col-md-3">NIDN</label>
						...
						<!-- #modal-detail -->
						<div id="Detdsn<?php echo $tdsn['id_dosen'];?>" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header bg-silver">
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="ion-close-circled"></i></button>
										<h5 class="modal-title"><i class="ion-ios-person text-danger"></i> &nbsp;Detail Data Dosen.</h5>
									</div>
									<div class="col-md-12">
										<div class="profile-section">
											<div class="col-md-12">
												<div class="modal-body">
													<label class="col-md-3"><b><u>Data Dosen</u></b></label>
													<span class="col-md-9"></span>
												</div>
												<div class="modal-body">
													<label class="col-md-3">NIDN</label>
													<span class="col-md-9">: <?=$tdsn['nidn']?></span>
												</div>
												<div class="modal-body">
													<label class="col-md-3">Nama Dosen</label>
													<span class="col-md-9">: <?=$tdsn['nama']?></span>	
												...
												<div class="modal-body">
													<label class="col-md-3">Bidang Studi</label>
													<span class="col-md-9">: <?=$tdsn['bdstudi']?></span>	
												</div>
												<br />
												<br />
											</div>
						...
						<div id="App<?php echo $data['id_skripsi']?>" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="col-sm-12">
										<div class="modal-body">
											<form action="index.php?page=approval-skripsi&id_skripsi=<?php echo $data['id_skripsi']?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
						...
						<!-- #modal-detail -->
						<div id="Send<?php echo $data['id_skripsi']?>" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title"><span class="label label-inverse"> # Dosen Pembimbing</span> &nbsp; Pengajuan Judul Skripsi <u><?php echo $tsis['nama']?></u>.</h5>
									</div>
									<div class="col-sm-12">
										<div class="modal-body">
											<form action="index.php?page=send-to-dosen&id_skripsi=<?php echo $data['id_skripsi']?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
												...
												<?php
													if ($data['id_dosen'] ==""){
														...
														echo '<p class="m-b-20">Dosen pembimbing 1 saat ini adalah <b>'.$tdsn['nama'].'</b>.<br />Apakah akan diganti?</p><hr />';
													}
												?>
												
												<div class="form-group col-sm-12">
													<label class="col-md-3 control-label">Pilih Dosen 1</label>
													<div class="col-md-9">
														<?php
															$selDsn = mysqli_query($gathuk, "SELECT * FROM tb_dosen ORDER BY nama");        
															echo '<select name="id_dosen" class="default-select2 form-control" style="width:100%" required>';    
															echo '<option value="">...</option>';    
																while ($rowdsn = mysqli_fetch_array($selDsn)) {    
																echo '<option value="'.$rowdsn['id_dosen'].'">'.$rowdsn['nidn'].' _ '.$rowdsn['nama'].'</option>';    
																}    
															echo '</select>';
														?>
													</div>
												...
												<?php
													if ($data['id_dosen'] ==""){
														...
														echo '<p class="m-b-20">Dosen pembimbing 2 saat ini adalah <b>'.$tdsn2['nama'].'</b>.<br />Apakah akan diganti?</p><hr />';
													}
												?>

												<div class="form-group col-sm-12">
													<label class="col-md-3 control-label">Pilih Dosen 2</label>
													<div class="col-md-9">
														<?php
															$selDsn2 = mysqli_query($gathuk, "SELECT * FROM tb_dosen ORDER BY nama");        
															echo '<select name="id_dosen2" class="default-select2 form-control" style="width:100%" required>';    
															echo '<option value="">...</option>';    
																while ($rowdsn2 = mysqli_fetch_array($selDsn2)) {    
																echo '<option value="'.$rowdsn2['id_dosen'].'">'.$rowdsn2['nidn'].' _ '.$rowdsn2['nama'].'</option>';    
																}    
															echo '</select>';
														?>
													</div>
