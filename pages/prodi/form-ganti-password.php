    ...
    <div class="col-sm-10 col-sm-offset-1">
		...
		<div class="panel panel-default" data-sortable-id="form-stuff-1">
			...
			<div class="panel-body">
				<form action="index.php?page=ganti-password&id_user=<?=$id_user?>" class="form-horizontal" method="POST" enctype="multipart/form-data" >
					...
					<div class="form-group">
						<label class="col-md-3 control-label"></label>
						<div class="col-md-6">
							<button type="submit" name="change" value="change" class="btn btn-danger"><i class="fa fa-key"></i>&nbsp;Change</button>&nbsp;
