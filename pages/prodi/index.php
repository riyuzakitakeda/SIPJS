		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li><a href="index.php?page=form-view-data-siswa"><i class="ion-ios-personadd-outline bg-warning"></i><span>Mahasiswa</span></a></li>
		...
		<div id="content" class="content">
			<?php
				...
				switch ($page) {
					...
					case 'print-skripsi': include "../../pages/prodi/report/print_skripsi.php"; break;
