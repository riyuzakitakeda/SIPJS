<!-- begin page-header -->
<h1 class="page-header">Data <small>Judul Skripsi <i class="fa fa-angle-right"></i>&nbsp;By Kategori</small></h1>
<!-- end page-header -->
<div class="profile-container">
	<!-- begin profile-section -->
	<div class="profile-section">
		<div class="panel-body">
			<form action="index.php?page=form-view-judul" class="form-horizontal" method="POST" enctype="multipart/form-data" >
				<div class="form-group">
					...
					<div class="col-md-3">
						...
						<a type="button" href="index.php?page=form-view-judul" class="btn btn-success"><i class="fa fa-refresh"></i>&nbsp;Refresh</a>
					</div>
				</div>
			</form>
		</div>
