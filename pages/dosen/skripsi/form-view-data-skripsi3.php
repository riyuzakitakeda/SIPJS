...
<?php
	...
	$query	=mysqli_query($gathuk, "SELECT * FROM tb_skripsi WHERE id_dosen3='$id_dosen' ORDER BY id_skripsi DESC");
?>
<div class="row">
	<!-- begin col-12 -->
    <div class="col-md-12">
				...
				<table id="data-table" class="table table-striped table-bordered nowrap" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php
								if ($data['approve_dosen3'] ==""){
									echo"Wait";	
								}
								else if ($data['approve_dosen3'] =="Y"){
									echo"Approved";	
								}
								else if ($data['approve_dosen3'] =="N"){
									echo"Not Approved";	
								}
								else{
										...
										<div class="profile-section">
											<div class="col-md-12">
												<div class="modal-body">
													<label class="col-md-3"><b><u>Data Siswa</u></b></label>
												...
												<div class="modal-body">
													...
													<span class="col-md-9">: <?php $tamDsn	=mysqli_query($gathuk, "SELECT * FROM tb_dosen WHERE id_dosen='$data[id_dosen3]'");
												...
												<div class="modal-body">
													...
													<span class="col-md-9">: <?=$data['catatan_dosen3']?></span>	
												</div>
												<br />
												<br />
											</div>
						...
						<div id="App<?php echo $data['id_skripsi']?>" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="col-sm-12">
										<div class="modal-body">
											<form action="index.php?page=approval-dosen3&id_skripsi=<?php echo $data['id_skripsi']?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
												<div class="form-group col-sm-12">
													<label class="col-md-3 control-label">Approval</label>
													<div class="col-md-8">
														<select name="approve_dosen3" class="default-select2 form-control" style="width:100%" required >
															<option value="">...</option>
												...
												<div class="form-group col-sm-12">
													...
													<div class="col-md-8">
														<textarea type="text" name="catatan_dosen3" maxlength="255" class="form-control"></textarea>
													</div>
												</div>
												<div class="form-group col-sm-12">
