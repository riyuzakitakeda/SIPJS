...
<?php
	...
	$query	=mysqli_query($gathuk, "SELECT * FROM tb_skripsi WHERE id_dosen='$id_dosen' ORDER BY id_skripsi DESC");
?>
<div class="row">
	<!-- begin col-12 -->
    <div class="col-md-12">
						...
						<div id="App<?php echo $data['id_skripsi']?>" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="col-sm-12">
										<div class="modal-body">
											<form action="index.php?page=approval-dosen&id_skripsi=<?php echo $data['id_skripsi']?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
												<div class="form-group col-sm-12">
													<label class="col-md-3 control-label">Approval</label>
													<div class="col-md-8">
														<select name="approve_dosen" class="default-select2 form-control" style="width:100%" required >
															<option value="">...</option>
												...
												<div class="form-group col-sm-12">
													...
													<div class="col-md-8">
														<textarea type="text" name="catatan_dosen" maxlength="255" class="form-control"></textarea>
													</div>
												</div>
												<div class="form-group col-sm-12">
