...
<?php
	...
	if ($_POST['edit'] == "edit") {
		...
		$new_name	="PRO-"."$datename"."-"."$idname".".$ext";
		...
		$update= mysqli_query ($gathuk, "UPDATE tb_berkas SET file_proposal='$new_name' WHERE id_berkas='$id_berkas'");
			if($update){
				$_SESSION['pesan'] = "Good! Upload berkas proposal success ...";
				header("location:index.php?page=form-view-data-berkas");
			}
			else {
