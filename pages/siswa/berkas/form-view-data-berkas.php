					...
					<tbody>
						...
						<tr>
							...
							<td><?php
								...
								?>&nbsp;
								<a type="button" class="pull-right" data-toggle="modal" data-target="#Hasil<?php echo $data['id_berkas']?>" title="upload berkas ujian hasil" style="cursor:pointer">Upload</a>
							</td>
							<td><?php
								if ($data['file_tutup'] ==""){
									echo"-";	
								...
								?>&nbsp;
								<a type="button" class="pull-right" data-toggle="modal" data-target="#Tutup<?php echo $data['id_berkas']?>" title="upload berkas ujian tutup" style="cursor:pointer">Upload</a>
							</td>
							<td><?php
								if ($data['file_jurnal'] ==""){
									echo"-";	
						...
						<!-- #modal-dialog -->
						<div id="Hasil<?php echo $data['id_berkas']?>" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
										<h4 class="modal-title"><i class="ion-ios-gear text-danger"></i> Ganti / Upload Berkas Hasil</h4>
									</div>
									<div class="col-sm-12">
										<div class="modal-body">
											<form action="index.php?page=upload-berkas-hasil&id_berkas=<?php echo $data['id_berkas']?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
												<div class="form-group col-sm-12">
													<label class="col-md-3 control-label">Pilih File</label>
													<div class="col-md-8">
														<input type="file" name="file_hasil" maxlength="255" class="form-control" required />
													</div>
												</div>
												<div class="form-group col-sm-12">
													<label class="col-md-3 control-label"></label>
													<div class="col-md-8">
														<p>* PDF. Max size 5 MB</p>
													</div>
												</div>
												<div class="form-group col-sm-12">
													<label class="col-md-3 control-label"></label>
						...
						<!-- #modal-dialog -->
						<div id="Tutup<?php echo $data['id_berkas']?>" class="modal fade" role="dialog">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
										<h4 class="modal-title"><i class="ion-ios-gear text-danger"></i> Ganti / Upload Berkas Tutup</h4>
									</div>
									<div class="col-sm-12">
										<div class="modal-body">
											<form action="index.php?page=upload-berkas-tutup&id_berkas=<?php echo $data['id_berkas']?>" class="form-horizontal" method="POST" enctype="multipart/form-data">
												<div class="form-group col-sm-12">
													<label class="col-md-3 control-label">Pilih File</label>
													<div class="col-md-8">
														<input type="file" name="file_tutup" maxlength="255" class="form-control" required />
													</div>
												</div>
												<div class="form-group col-sm-12">
													<label class="col-md-3 control-label"></label>
